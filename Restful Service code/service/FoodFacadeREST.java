...
public class FoodFacadeREST extends AbstractFacade<Food> {
    ...
    public List<Food> findByIdPassword(@PathParam("name") String name) {
        Query q = em.createQuery("select f from Food f WHERE f.name LIKE '%" + name + "%' ", Food.class);
